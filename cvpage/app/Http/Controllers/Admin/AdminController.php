...
class AdminController extends Controller {
	...
	//Creamos un metodo privado para comprobar si se trata de un administrador con el uso de la columna user_id
	//
	...
	// Creamos la wiew de Administrador
...
//El valor 1 en la columna determina si el usuario es administrador o no
		...
		return View('admin.administrador.createadmin');
	}
}
